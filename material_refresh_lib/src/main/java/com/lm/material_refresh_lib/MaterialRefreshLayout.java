        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy > 0 && !canChildScrollUp()) {
                    ...
                    } else if (myLoading != null) {
                        myLoading.setVisibility(View.VISIBLE);
                        myLoading.onBegin(this);
                    }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mChildView != null) {
                    ...
                    if (mMaterialHeaderView != null) {
                        ...
                        myLoading.getLayoutParams().height = (int) offsetY;
                        myLoading.requestLayout();
                        myLoading.onPull(this, fraction);
                    }
            ...
            case MotionEvent.ACTION_UP:
                if (mChildView != null) {
                    ...
                    if (mMaterialHeaderView != null) {
                        ...
                        if (isOverlay) {
                            if (myLoading.getLayoutParams().height > mHeadHeight) {

                                updateListener();

                                myLoading.getLayoutParams().height = (int) mHeadHeight;
                                myLoading.requestLayout();

                            } else {
                                myLoading.getLayoutParams().height = 0;
                                myLoading.requestLayout();
                            }

                        } else {
                            if (ViewCompat.getTranslationY(mChildView) >= mHeadHeight) {
                                createAnimatorTranslationY(mChildView, mHeadHeight, myLoading);
                                updateListener();
                            } else {
                                createAnimatorTranslationY(mChildView, 0, myLoading);
                            }
                        }
                    }
