 ...
 */
    ...
    public class MyFootLoading extends FrameLayout implements MaterialHeadListener {
        ...
        public MyFootLoading(Context context) {
            super(context);
            initView(context);
        }

        public MyFootLoading(Context context, AttributeSet attrs) {
            super(context, attrs);
            initView(context);
        }
        ...
        private void initView(Context context) {
            ...
            LayoutParams imgLp = new LayoutParams(150,
                    150);
