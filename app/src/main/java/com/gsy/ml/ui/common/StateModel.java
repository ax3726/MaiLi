...
public class StateModel extends BaseObservable {
    ...
    private Context mContext = MaiLiApplication.getInstance();
    ...
    private int mRes = R.drawable.no_data_ml_icon;
    ...
    public Drawable getEmptyIconRes() {
        switch (emptyState) {
            case EmptyState.EMPTY:
                return ContextCompat.getDrawable(mContext, R.drawable.no_data_ml_icon);
            case EmptyState.NET_ERROR:
            ...
            case EmptyState.EXPAND1:
                return ContextCompat.getDrawable(mContext, R.drawable.bank_icon);
            case EmptyState.EXPAND2:
                return ContextCompat.getDrawable(mContext, R.drawable.no_data1_icon);
            default:
                return ContextCompat.getDrawable(mContext, R.drawable.no_data_icon);
        }
    }
