...
public class BankEditTextView extends android.support.v7.widget.AppCompatEditText {
    ...
    public BankEditTextView(Context context, AttributeSet attrs, int defStyleAttr) {
