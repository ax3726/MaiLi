...
public class LocationHelper {
    ...
    private static LocationHelper mLocationHelper1 = null;
    ...
    public static LocationHelper getInstance1() {
        if (mLocationHelper1 == null) {
            mLocationHelper1 = new LocationHelper();
        }
        return mLocationHelper1;
    }
