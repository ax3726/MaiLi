...
import com.gsy.ml.databinding.ActivityPartTimeJobDetailsBinding;
...
public class PartTimejobDetailsActivity extends BaseActivity implements ILoadPVListener, View.OnClickListener {
    private ActivityPartTimeJobDetailsBinding mBinding;
    ...
    public void initData() {
        super.initData();
        mBinding = (ActivityPartTimeJobDetailsBinding) vdb;
