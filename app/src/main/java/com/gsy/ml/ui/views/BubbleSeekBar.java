...
import static com.gsy.ml.ui.views.BubbleSeekBar.TextPosition.SIDES;
...
//    @Retention(RetentionPolicy.SOURCE)
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMin = a.getInteger(R.styleable.BubbleSeekBar_bsb_min,  11);
        ...
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.colorRound));
