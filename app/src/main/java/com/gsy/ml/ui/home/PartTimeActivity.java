...
public class PartTimeActivity extends BaseActivity implements ILoadPVListener, View.OnClickListener {
    private ActivityPartTimeBinding mBinding;
    ...
    public void initData() {
        super.initData();
        mBinding = (ActivityPartTimeBinding) vdb;
