...
public class EaseChatInputMenu extends LinearLayout {
    ...
    protected CommonLanguage mCommonLanguage;//常用语
    protected FrameLayout chatExtendMenuContainer;
    protected FrameLayout commmon_language_container;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        commmon_language_container = (FrameLayout) findViewById(R.id.commmon_language_container);
    ...
    public void setIsInput(boolean isshow) {
        ((EaseChatPrimaryMenu) chatPrimaryMenu).setInputType(isshow);
    }
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        mCommonLanguage = new CommonLanguage(context);

        commmon_language_container.addView(mCommonLanguage);
        ...
        mCommonLanguage.setCommonLanguageListener(new CommonLanguage.CommonLanguageListener() {
            @Override
            public void onItemClick(String item) {
                if (chatPrimaryMenu != null) {
                    ((EaseChatPrimaryMenu) chatPrimaryMenu).setEditContentText(item);
                }
            }
        });
    ...
    protected void processChatMenu() {
        ...
        chatPrimaryMenu.setChatPrimaryMenuListener(new EaseChatPrimaryMenuListener() {
            ...
            @Override
            public void onCommonLanguageClicked() {
                commonLanguage();
            }
     ...
     */
    protected void commonLanguage() {
        if (chatExtendMenuContainer.getVisibility() == View.GONE) {
            hideKeyboard();
            handler.postDelayed(new Runnable() {
                public void run() {
                    commmon_language_container.setVisibility(View.VISIBLE);
            ...
            if (emojiconMenu.getVisibility() == View.VISIBLE) {
                emojiconMenu.setVisibility(View.GONE);
                commmon_language_container.setVisibility(View.VISIBLE);
            } else if (emojiconMenu.getVisibility() == View.VISIBLE) {
                emojiconMenu.setVisibility(View.GONE);
                commmon_language_container.setVisibility(View.VISIBLE);
            } else {
        ...
        if (chatExtendMenuContainer.getVisibility() == View.GONE) {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    emojiconMenu.setVisibility(View.GONE);
                    commmon_language_container.setVisibility(View.GONE);
                }
            }, 50);
        } else {
            if (emojiconMenu.getVisibility() == View.VISIBLE) {
                ...
                commmon_language_container.setVisibility(View.GONE);
                chatExtendMenu.setVisibility(View.VISIBLE);
            } else if (commmon_language_container.getVisibility() == View.VISIBLE) {
                commmon_language_container.setVisibility(View.GONE);
                chatExtendMenu.setVisibility(View.VISIBLE);
            } else {
                chatExtendMenuContainer.setVisibility(View.GONE);
