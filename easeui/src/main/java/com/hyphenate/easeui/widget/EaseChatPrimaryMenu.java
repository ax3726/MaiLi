...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    private TextView btn_chang;
    private boolean ctrlPress = false;
    private boolean mIsshow = true;//普通模式  1关闭下面的菜单
    ...
    //设置输入类型
    public void setInputType(boolean isshow) {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        btn_chang = (TextView) findViewById(R.id.btn_chang);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_send) {
            ...
            showNormalFaceImage();
            if (listener != null)
                listener.onCommonLanguageClicked();
    ...
    public void setEditContentText(String txt) {
